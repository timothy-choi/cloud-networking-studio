...
This document ties together persistence, APIs, services, and the Docker-backed runtime. It also explains **why** this project maps cleanly to distributed systems, cloud, and platform engineering interviews. For a shorter **portfolio / interview** overview, see [ARCHITECTURE.md](ARCHITECTURE.md).
...
- [ARCHITECTURE.md](ARCHITECTURE.md) — Shorter portfolio / interviewer overview of the same themes.
